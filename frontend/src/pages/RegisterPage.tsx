...
export function RegisterPage() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center overflow-y-auto p-4 sm:p-6">
      <div className="w-[420px] max-w-full rounded-2xl border border-(--color-border) bg-(--color-surface) p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] sm:p-9">
        ...
        <h1 className="mb-1.5 text-[22px] font-bold tracking-tight">Create your account</h1>
        ...
        <p className="mt-5 text-center text-[13px] text-(--color-text-muted)">
          ...
          <Link to="/login" className="font-semibold text-(--color-accent) no-underline">
            Sign in
          </Link>
        </p>
      </div>
