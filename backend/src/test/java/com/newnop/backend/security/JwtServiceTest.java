...
class JwtServiceTest {
  ...
  void setUp() {
    ...
    userDetails =
        User.builder().username("user@example.com").password("irrelevant").roles("USER").build();
  }
  ...
  void isTokenValid_forDifferentUser_returnsFalse() {
    ...
    UserDetails otherUser =
        User.builder().username("other@example.com").password("irrelevant").roles("USER").build();
